...
//       // // Notify navbar and any auth-dependent components immediately
...
//       <div className="w-full max-w-5xl overflow-hidden rounded-3xl bg-white/10 shadow-2xl">
//         <div className="grid grid-cols-1 md:grid-cols-2">
...
//               Log in to book indoor cricket grounds and manage your reservations
//               easily.
//             </p>
...
//                           d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-4-9-7 0-1.165.568-2.42 1.568-3.568M6.223 6.223A9.956 9.956 0 0112 5c5 0 9 4 9 7 0 1.438-.73 3.014-2.025 4.39M15 12a3 3 0 11-6 0 3 3 0 016 0zM3 3l18 18"
//                         />
//                       </svg>
//                     ) : (
//                       <svg
...
//                 type="submit"
//                 disabled={loading}
//                 className="w-full rounded-full bg-green-700 py-3 font-semibold text-white shadow-md transition hover:bg-green-800 disabled:cursor-not-allowed disabled:opacity-70"
//               >
...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // backward compatibility for pages still using old keys
